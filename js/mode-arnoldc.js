...
var ArnoldCHighlightRules = function() {
    this.$rules = {
        start: [{
            ...
            regex: /HEY CHRISTMAS TREE|YOU SET US UP|YOU HAVE BEEN TERMINATED|GET TO THE CHOPPER|ENOUGH TALK|HERE IS MY INVITATION|GET UP|LET OFF SOME STEAM BENNET|HASTA LA VISTA, BABY/
        }, {
            token: "keyword.control",
